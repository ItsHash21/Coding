/*
For a given string(str) and a character X, complete the definition of the functions that removes all the 
characters in string(str) that matches the character X.
